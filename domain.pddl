(define (domain Dungeon)
    ...
    (:action move
        ...
        :effect (and
            ...
            (not (hero-at ?from))
            (not (hero-move-to ?to))
            ;if corridor is risky make destination room messy
            ;and set location corridor predicates to false
    ...
    (:action unlock
        ...
        :effect (and
            ;if key is oneUse then set it to no-use
            ;else if its two use then set it to one use
